...
# fast exchange and exchange functions yield the same results - anticluster editing (max diversity)
# for K = 2
K <- 2
clusters <- rep(1:K, 5)
...
# same results for local updating and recomputing - different group sizes"
N <- 60 
M <- 2
